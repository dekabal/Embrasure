...
BasicGame.Floor_One.prototype = {
    ...
    lose: function(player,monster){
        ...
        if(text == null){
            ...
            if(player.position.x >= 1280 && player.position.x <= 1536 && player.position.y >= 992 && player.position.y <= 1056){
            ...
            else if(player.position.x >= 1248 && player.position.x <= 1536 && player.position.y >= 224 && player.position.y <= 896){
