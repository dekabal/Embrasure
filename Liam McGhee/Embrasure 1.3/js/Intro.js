...
BasicGame.Intro.prototype = {
    ...
    create: function () {
        ...
        // set-up world map
        map = this.add.tilemap('level_intro');
    ...
    // player collision with environment
        ...
        if(player.position.x >= 1568 && player.position.x <= 1696 && player.position.y >= 1120 && player.position.y <= 1248){
            this.win(player);
        }
    ...
    interact: function(){
        this.game.physics.arcade.overlap(player, items, this.acquireKey, null, this);
    },
    ...
    createPlayer: function(){
        ...
        var temp_player = this.add.sprite(this.world.centerX, 1664,'james');
