...
BasicGame.Intro.prototype = {
    ...
    create: function () {
        ...
        //layer1 = map.createLayer('Floor', map.widthInPixels, map.heightInPixels, this.mapGroup);
        layer1 = map.createLayer('Floor');
        layer1.resizeWorld();

        //layer2 = map.createLayer('Walls', map.widthInPixels, map.heightInPixels, this.mapGroup);
        layer2 = map.createLayer('Walls');
        layer2.resizeWorld();
        
        //layer3 = map.createLayer('Objects', map.widthInPixels, map.heightInPixels, this.mapGroup);
    ...
    createDoors: function(){
        ...
        var temp_door = this.add.sprite(1632, 768,'metal_door32');
