...
BasicGame.Boot.prototype = {
    ...
    preload: function () {
        ...
        this.load.image('up_stairs', 'assets/imgs/floor_one/items/stairs_up_right.png');
        this.load.image('down_stairs', 'assets/imgs/floor_one/items/stairs_down_left.png');
        this.load.image('jerry_can', 'assets/imgs/floor_intro/items/jerry_can.png');
        this.load.image('pallet', 'assets/imgs/pallet1.png');
        this.load.image('covered_crate', 'assets/imgs/covered_crates.png');
 ...
 this.load.image('door_normal_barbed32','assets/imgs/doors/door_normal_barbed32.png');
        ...
        this.load.image('elevator1_tileset','assets/imgs/elevator1_tileset.png',32,32);
