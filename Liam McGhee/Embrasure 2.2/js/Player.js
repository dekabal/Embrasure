...
Player.prototype = {
    ...
    movePlayer: function(){
        // player movement
        if(this.game.input.keyboard.isDown(Phaser.Keyboard.LEFT) && this.ableToMove){
        ...
        else if(this.game.input.keyboard.isDown(Phaser.Keyboard.RIGHT) && this.ableToMove){
            this.sprite.body.velocity.y = 0;
        ...
        else if(this.game.input.keyboard.isDown(Phaser.Keyboard.UP) && this.ableToMove){
        ...
        else if(this.game.input.keyboard.isDown(Phaser.Keyboard.DOWN) && this.ableToMove){
            this.sprite.body.velocity.x = 0;
            this.direction = "down";
            this.light.angle = 1.5;
            this.yOffset = 12
