...
BasicGame.Floor_One.prototype = {
    ...
    create: function () {
        ...
        player = new Player(this, 'james',0,0,1);
    ...
    // player collision with environment
        ...
        if(player.sprite.position.x >= 2112 && player.sprite.position.x <= 2368 && player.sprite.position.y >= 608 && player.sprite.position.y <= 768){
