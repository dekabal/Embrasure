...
BasicGame.Level_One.prototype = {
    ...
    // player collision with environment
        ...
        if(player.position.y >= 2384 && player.position.x > 784 && player.position.x < 832){
            ...
            if(blue_man.alive){
                this.physics.overlap(player,blue_man, this.lose, null, this);
                timer += 1;
                
                if(this.physics.overlap(player,blue_man, this.lose, null, this)){
                }else if(timer > 200){
                ...
                if(this.physics.collide(blue_man,layer1))
                    blue_man.destroy();
            }
        ...
        this.physics.overlap(player,eyeless_girl, this.lose, null, this);
        this.physics.overlap(player,monster, this.lose, null, this);
